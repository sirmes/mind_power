					...
					<form action="http://182.239.48.184/~ceompowe/mp_assessement/insert.php" method="post" name="send_questions" id="send_questions">
										...
										<tr class="<?php echo "$row_color"; ?>"> 
											...
											<td>
												<span>
													...
													<?php   // Added by Plato 2012-06-18 (Comment by Isabella: Reset bg color when sected) --------?>
													onclick="javascript:resetQuestionBackgroundColor(this);" />
													<?php   // Ended by Plato 2012-06-18 (Comment by Isabella: Reset bg color when sected) --------?>
												</span>
											</td>
										</tr>
						...
						<div id="form3">
							...
							<table >
						        ...
						        <tr style=""><!-- Hide passcode for demo by Plato 2012-06-18 -->
