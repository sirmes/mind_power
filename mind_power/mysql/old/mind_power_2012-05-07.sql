...
# Database: mind_power
# Generation Time: 2012-05-07 12:00:02 -0400
# ************************************************************
...
INSERT INTO `questions_answers` (`id`, `id_category`, `id_sub_category`, `answer_group`, `question`)
VALUES
	...
	(10,2,2,5,'New question 1111'),
	(11,3,1,3,'New question/answer - nes answer');
...
CREATE TABLE `testers_answers_counts` (
  ...
  `id_category` int(11) NOT NULL,
  `id_sub_category` int(11) NOT NULL,
  `sub_categoty_count` int(11) NOT NULL,
  `sub_category_percentage` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
